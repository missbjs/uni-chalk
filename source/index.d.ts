...
export interface Options {
	...
	*/
	...
	/**
	Force browser mode for CSS styling instead of ANSI escape codes.
	By default, mode is automatically detected based on the environment.
	*/
...
export interface ChalkInstance {
	(...text: unknown[]): string | [string, string]
	...
	*/
	...
	/**
	Whether Chalk is in browser mode (CSS styling) or Node.js mode (ANSI codes).
	Automatically detected based on environment, but can be overridden.
	*/
...
In Node.js environments, returns a string with ANSI escape codes.
In browser environments, returns either a string or a tuple [formattedString, cssStyle] for use with console.log.
*/
declare const chalk: ChalkInstance

// Browser-specific Chalk instance that always returns CSS styling
export interface BrowserChalkInstance extends ChalkInstance {
...
[More colors here.](https://github.com/missbjs/uni-chalk/blob/main/readme.md#256-and-truecolor-color-support)
*/
